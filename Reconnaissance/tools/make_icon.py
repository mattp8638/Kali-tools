...
Usage:
  - Place your `recce.png` image in the same folder as this repo's `Reconnaissance` folder.
  - From the `Reconnaissance` folder run:
      python ..\tools\make_icon.py recce.png recce.ico
